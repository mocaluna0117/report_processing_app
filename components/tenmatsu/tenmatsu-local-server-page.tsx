...
/**
 * 今までの方式（PCで動く Python のローカルサーバーにつなぐ）の画面。
 * 新しい方式（tenmatsu-folder-page.tsx）と切り替えられるように残してある。
 * ★2人とも新しい方式で回るようになるまで、中身は変えない。
 */
export function TenmatsuLocalServerPage({ kind: kindId, header }: { kind: DocKindId; header?: ReactNode }) {
